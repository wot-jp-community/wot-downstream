...
-「Smart Factory」や「Smart City」等については，日本語として一般的に用いられている場合，一語(「スマートファクトリー」等)として表記する．
...
- 英語の複合語(例: Edge Device)を日本語にする場合、日本語として通常用いられている用語の場合は、「エッジ・デバイス」というように中点を付与することはせず，一単語として「エッジデバイス」のように記述する．
